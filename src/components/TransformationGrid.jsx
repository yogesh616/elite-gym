...
function TransformationGrid() {
  return (
    <section className="py-8">
      <h2 className="text-white text-2xl md:text-4xl font-extrabold mb-8">Transformation Stories</h2>
          ...
          >
            <div className="flex gap-2">
              <img
                ...
                alt={`${c.name} Before`}
                loading="lazy"
                className="w-24 h-32 object-cover rounded-md brightness-75
                  transition duration-200 hover:scale-105 hover:brightness-100 focus:scale-105 focus:brightness-100"
                tabIndex={-1}
                draggable={false}
              />
              <img
                ...
                alt={`${c.name} After`}
                loading="lazy"
                className="w-24 h-32 object-cover rounded-md brightness-100 shadow-lg
                  transition duration-200 hover:scale-110 hover:shadow-green-500 focus:scale-110 focus:shadow-green-500"
                tabIndex={-1}
                draggable={false}
              />
            </div>
            <div className="mt-4 text-center">
              ...
              <span className="block text-md text-green-400">{c.summary}</span>
            </div>
          </div>
        ))}
      </div>
