...
function HeroBanner() {
  ...
  // Autoplay slider, 5s per slide, pause on hover
  useEffect(() => {
  ...
  return (
    <section
      ...
      aria-label="Elite Gym hero slider"
    >
      {/* Transition images, only active one in DOM for memory efficiency */}
      ...
      >
        <h1 className="text-white text-4xl xs:text-5xl md:text-7xl font-black mb-3 md:mb-6 tracking-tight leading-tight shadow-xl">
          {heroText.heading}
        </h1>
        <p className="text-white text-base xs:text-xl md:text-3xl font-bold mb-6 md:mb-10 text-center max-w-2xl drop-shadow">
          {heroText.sub}
        </p>
        <a
      ...
      {/* Carousel Controls — optional, premium style */}
